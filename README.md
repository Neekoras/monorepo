...
`utopia-php/compression` and `utopia-php/system` are maintained in [Appwrite](https://github.com/appwrite/appwrite/tree/main/packages). Their distribution mirrors and Packagist packages remain available.
