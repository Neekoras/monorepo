...
final class RedisCodecTest extends TestCase
{
    ...
    public function testPublishAndReceiveRoundTrip(Codec $codec): void
    {
        ...
        $message = $broker->consume($queue, 0)[0] ?? null;
    ...
    public function testCompatReadsAMessageAnEarlierReleaseWrote(): void
    {
        ...
        $message = (new Broker($connection, $connection, new Compat($writer))->consume($queue, 0)[0] ?? null);
    ...
    public function testAnUnreadableMessageIsParkedAndTheQueueKeepsMoving(): void
    {
        ...
        $this->assertNotInstanceOf(Message::class, ($broker->consume($queue, 0)[0] ?? null), 'the unreadable message is not handed to a handler');
        $this->assertSame(
            [$poison],
    ...
    public function testAWellFormedNonEnvelopeIsParked(): void
    {
        ...
        $this->assertNotInstanceOf(Message::class, ($broker->consume($queue, 0)[0] ?? null));
