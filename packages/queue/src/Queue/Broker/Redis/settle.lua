local function settle(KEYS, ARGV)
    ...
    -- ARGV: token, pid, outcome (0 failure, 1 success, 2 release), retained payload ttl.
    ...
    if ARGV[3] ~= '1' and not raw then return redis.error_reply('Queue delivery payload is missing') end
